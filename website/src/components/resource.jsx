        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Insights and guidance from our team of mental health professionals.
            </p>
          </div>
            ...
            {[
              {
                ...
                excerpt: 'Explore the physiological and psychological aspects of anxiety and learn effective strategies for managing symptoms.',
                author: 'Dr. Elizabeth Chen',
                date: 'April 15, 2025',
                image: '/api/placeholder/600/400'
              },
              {
                title: 'The Power of Boundaries in Relationships',
                excerpt: 'Learn how establishing healthy boundaries can improve your relationships and enhance your emotional wellbeing.',
              ...
              },
              {
                ...
                excerpt: 'Discover accessible mindfulness techniques that can be incorporated into your daily routine to reduce stress.',
                author: 'Lisa Chen, RYT',
                date: 'March 28, 2025',
                image: '/api/placeholder/600/400'
              }
            ].map((article, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button 
                    ...
                    onClick={() => toast.success(`Article: ${article.title} viewed`)}
                  >
                    <span>Read more</span>
          ...
          <div className="text-center mt-12">
            <button 
              ...
              onClick={() => toast.success("More articles viewed")}
            >
