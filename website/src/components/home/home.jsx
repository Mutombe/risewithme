...
function HomePage() {
  ...
  const testimonials = [
    {
      quote: "Working with Lilian has been transformative. I've developed tools to manage anxiety that I never thought possible.",
      author: "Sarah K.",
  ...
  return (
    <div>
        ...
        <div className="block md:hidden">
          ...
          <div className="container mx-auto px-4 py-10">
            ...
            <div className="space-y-4">
              <a href="tel:2894023685" className="w-full bg-teal-600 text-white hover:bg-teal-700 font-medium py-3 px-6 rounded-md transition-colors flex items-center justify-center shadow-lg">
                <span>Book A Free Consultation</span>
              </a>
              <a href="tel:2894023685" className="w-full bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 font-medium py-3 px-6 rounded-md transition-colors flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 lg:pr-8">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <a href="tel:2894023685" className="bg-teal-600 text-white hover:bg-teal-700 font-medium py-3 px-6 rounded-md transition-colors flex items-center justify-center shadow-lg">
                    <span>Book A Free Consultation</span>
                  </a>
                  <a href="tel:2894023685" className="bg-white text-teal-600 border-2 border-teal-600 hover:bg-teal-50 font-medium py-3 px-6 rounded-md transition-colors flex items-center justify-center">
                    <Phone className="mr-2" size={18} />
                    <span>Contact Us</span>
                  </a>
                </div>
              ...
              <div className="lg:col-span-7 relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-5 max-w-xs border-l-4 border-teal-600">
                  ...
                  <p className="text-sm text-gray-600">Weekday evenings & weekend sessions available</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-8">
                <div className="flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Weekday Evenings & Weekend Sessions</p>
                  </div>
                </div>
                <div className="flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-teal-500 text-white p-6 rounded-xl shadow-lg max-w-xs">
                ...
                <p className="text-sm opacity-90">Registered Psychotherapist (Qualifying), MACP, MBA, BBA, SSW</p>
              </div>
            </div>
            
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Meet Your Therapist</h2>
              ...
              <p className="text-lg text-gray-600 mb-8">
                I specialize in CBT, Trauma, EFT and Talk therapy to help you manage and collaboratively work on your healing. I am eager to help you navigate life issues and include life coaching if needed through Solution Focused Therapy. I also offer Christian counseling for those who identify with Christianity. Wanting to identify with your culture, I am here for you.
              </p>
              
              <a href="tel:2894023685" className="bg-teal-600 text-white hover:bg-teal-700 font-medium py-3 px-6 rounded-md transition-colors inline-flex items-center shadow-lg">
                <Phone className="mr-2" size={18} />
      ...
      <section className="py-20 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">How I Can Help</h2>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Specialties & Expertise</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Specialized therapeutic approaches for a wide range of mental health concerns.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              "Anxiety", "Depression", "Trauma and PTSD", "Addiction", "ADHD", 
              "Alcohol Use", "Anger Management", "Behavioural Issues", "Borderline Personality (BPD)",
              "Caregivers", "Coping Skills", "Dissociative Disorders (DID)", "Divorce", 
              "Domestic Abuse", "Domestic Violence", "Eating Disorders", "Emotional Disturbance",
              "Family Conflict", "Geriatric and Seniors", "Grief", "Infidelity", 
              "Life Coaching", "Life Transitions", "Parenting", "Self Esteem"
            ].map((specialty, index) => (
              <div 
                key={index}
                className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
              >
                <p className="text-teal-600 font-medium text-center">{specialty}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-teal-50 to-white">
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Professional Endorsements</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                What colleagues in the field have to say about my therapeutic approach.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-teal-50 p-6 rounded-xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Registered Psychotherapist, BEd, MA, MPS, RP, OCT</p>
                </div>
              </div>
              
              <div className="bg-teal-50 p-6 rounded-xl shadow-sm">
                <p className="text-gray-700 mb-4 italic">
                  "Lilian brings a unique blend of professional expertise and genuine compassion to her practice. Her ability to create a safe and supportive environment allows clients to explore their challenges and find meaningful paths to healing."
                </p>
                <div>
                  <p className="font-semibold text-teal-600">Karen Rezk</p>
                  <p className="text-sm text-gray-500">Registered Psychotherapist (Qualifying), RPQ, MDiv, MScA, RN</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-teal-500 to-cyan-600 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto opacity-90">
              Take the first step toward a healthier, more balanced life. I'm ready to support you.
            </p>
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <a href="tel:2894023685"
              ...
              <a href="mailto:lilian@example.com"
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-2 lg:order-1">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">My Therapeutic Approach</h2>
                <p className="text-lg text-gray-600 mb-6">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  "I start with Cognitive Behavioral Therapy (CBT) because it provides a strong foundation for understanding how your thoughts influence your emotions and experiences. CBT is a powerful tool for helping you reframe unhelpful thought patterns. From there, we can integrate other therapeutic approaches as needed to best suit your unique journey. As we work together, I commit to support you all the way."
                </p>
                
                <div className="flex flex-wrap gap-3 mt-8">
                  {[
                    "Cognitive Behavioural (CBT)", "Dialectical Behavior (DBT)", "Emotionally Focused",
                    "Family Systems", "Trauma Focused", "Solution Focused Brief (SFBT)", "Talk Therapy"
                  ].map((approach, index) => (
                    <span key={index} className="bg-teal-50 text-teal-600 px-3 py-1 rounded-full text-sm font-medium">
                      {approach}
                    </span>
                  ))}
                </div>
              ...
              <div className="order-1 lg:order-2 relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-teal-500 text-white p-6 rounded-xl shadow-lg max-w-xs">
                  ...
                  <p className="text-sm opacity-90">Every treatment plan is tailored to your unique needs, goals, and personal circumstances.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-b from-white to-teal-50">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Practice Information</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-teal-500">
                ...
                <p className="text-gray-600 mb-4">
                  I offer therapy sessions mainly virtually by video or phone, (in-person by arrangement).
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-teal-500">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 mt-4 text-sm">
                    Insurance receipts provided. Sliding scale available for eligible clients.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-sm">
                  <h3 className="text-lg font-semibold text-teal-600 mb-3">{faq.q}</h3>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Ready to take the first step? Reach out for a free 15-minute consultation to see if we're a good fit.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-800 mb-1">Locations</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Weekday Evenings & All Day Weekends</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="#" className="bg-teal-100 text-teal-600 p-2 rounded-full hover:bg-teal-200 transition-colors">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
              <div>
                ...
                <p className="text-gray-300 mb-4">Registered Psychotherapist (Qualifying), MACP, MBA, BBA, SSW</p>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li><a href="#" className="hover:text-teal-300 transition-colors">About Me</a></li>
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Services</a></li>
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Approach</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Individual Therapy</a></li>
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Couples Therapy</a></li>
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Family Therapy</a></li>
                  <li><a href="#" className="hover:text-teal-300 transition-colors">Life Coaching</a></li>
                </ul>
              </div>
            ...
            <div className="border-t border-gray-700 pt-6">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-400 text-sm mb-4 md:mb-0">
                  &copy; {new Date().getFullYear()} Lilian Shonhiwa Psychotherapy. All rights reserved.
                </p>
                <div className="flex space-x-4">
                  ...
                  <a href="#" className="text-gray-400 hover:text-teal-300 transition-colors">Accessibility</a>
                </div>
              </div>
            </div>
          </div>
